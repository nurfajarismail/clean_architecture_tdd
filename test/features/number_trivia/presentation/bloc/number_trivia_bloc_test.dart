...
import 'package:clean_architecture_tdd/features/number_trivia/presentaton/bloc/number_trivia_bloc.dart';
...
void main() {
  ...
  group('GetTriviaForConcreteNumber', () {
    ...
    test(
      'should emit [Loading, Error] when propper message for the error when getting data fails',
      () async* {
        // arrange
        setUpMockInputConverterSuccess();
        when(mockGetConcreteNumberTrivia!(any))
